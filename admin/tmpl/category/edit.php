    ...
    <div class="row">
        <div class="col-md-7">
            <fieldset class="adminform">
                <legend><?php echo Text::_('com_planjeagenda_CATEGORY_FIELDSET_DETAILS');?></legend>
                <ul class="adminformlist">
                    ...
                    <li><div class="label-form"><?php echo $this->form->renderfield('icon'); ?></div></li>
                </ul>
                <div class="clr"></div>
        ...
        <div class="col-md-5">
            <div class="accordion" id="accordionCategoriesForm">
                ...
                <div class="accordion-item">
                    ...
                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#confemail" aria-expanded="true" aria-controls="confemail">
                        <?php echo Text::_('com_planjeagenda_CATEGORY_FIELDSET_EMAIL'); ?>
                    </button>
                    </h2>
            ...
            <?php foreach ($fieldSets as $name => $fieldSet) : ?>
                <?php $label = !empty($fieldSet->label) ? $fieldSet->label : 'com_planjeagenda_'.$name.'_FIELDSET_LABEL'; ?>
