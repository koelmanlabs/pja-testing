...
<div class="width-50 fltlft">
    <div class="width-100" style="padding: 10px 1vw;">
        <fieldset class="options-form">
            <legend><?php echo Text::_('com_planjeagenda_GENERAL_LAYOUT_SETTINGS'); ?></legend>
    ...
    <div class="width-100" style="padding: 10px 1vw;">
        <fieldset class="options-form">
            <legend><?php echo Text::_('com_planjeagenda_DATE_COLUMN'); ?></legend>
            <ul class="adminformlist">
    ...
    <div class="width-100" style="padding: 10px 1vw;">
        <fieldset class="options-form">
            <legend><?php echo Text::_('com_planjeagenda_TITLE_COLUMN'); ?></legend>
            <ul class="adminformlist">
    ...
    <div class="width-100" style="padding: 10px 1vw;">
        <fieldset class="options-form">
            <legend><?php echo Text::_('com_planjeagenda_VENUE_COLUMN'); ?></legend>
            <ul class="adminformlist">
    ...
    <div class="width-100" style="padding: 10px 1vw;">
        <fieldset class="options-form">
            <legend><?php echo Text::_('com_planjeagenda_CITY_COLUMN'); ?></legend>
            <ul class="adminformlist">
    ...
    <div class="width-100" style="padding: 10px 1vw;">
        <fieldset class="options-form">
            <legend><?php echo Text::_('com_planjeagenda_STATE_COLUMN'); ?></legend>
            <ul class="adminformlist">
    ...
    <div class="width-100" style="padding: 10px 1vw;">
        <fieldset class="options-form">
            <legend><?php echo Text::_('com_planjeagenda_CATEGORY_COLUMN'); ?></legend>
            <ul class="adminformlist">
    ...
    <div class="width-100" style="padding: 10px 1vw;">
        <fieldset class="options-form">
            <legend><?php echo Text::_('com_planjeagenda_ATTENDEE_COLUMN'); ?></legend>
            <ul class="adminformlist">
    ...
    <div class="width-100" style="padding: 10px 1vw;">
        <fieldset class="options-form">
            <legend><?php echo Text::_('com_planjeagenda_LAYOUT_TABLE_EVENTIMAGE'); ?></legend>
            <ul class="adminformlist">
...
<div class="width-50 fltrt">
    <div class="width-100" style="padding: 10px 1vw;">
        <fieldset class="options-form">
        <legend><?php echo Text::_('com_planjeagenda_SETTINGS_LEGEND_CSS'); ?></legend>
        <ul class="adminformlist">
    ...
    <div class="width-100" style="padding: 10px 1vw;">
        <fieldset class="options-form">
        <legend><?php echo Text::_('com_planjeagenda_SETTINGS_LEGEND_CSS_COLOR_BACKGROUND'); ?></legend>
    ...
    <div class="width-100" style="padding: 10px 1vw;">
        <fieldset class="options-form">
        <legend><?php echo Text::_('com_planjeagenda_SETTINGS_LEGEND_CSS_COLOR_BORDER'); ?></legend>
        <ul class="adminformlist label-button-line">
    ...
    <div class="width-100" style="padding: 10px 1vw;">
        <fieldset class="options-form">
        <legend><?php echo Text::_('com_planjeagenda_SETTINGS_LEGEND_CSS_COLOR_FONT'); ?></legend>
        <ul class="adminformlist label-button-line">
