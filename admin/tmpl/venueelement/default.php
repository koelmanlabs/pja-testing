...
<form action="index.php?option=com_planjeagenda&amp;view=venueelement&amp;tmpl=component" method="post" name="adminForm" id="adminForm">
...
<table class="adminform">
    <tr>
        <td style="width: 100%;"><div class="input-group">
            ...
            <button type="button" class="filter-search-bar__button btn btn-danger"" onclick="if (window.parent) window.parent.<?php echo $this->escape($function);?>('', '<?php echo Text::_('com_planjeagenda_SELECTVENUE') ?>');"><?php echo Text::_('com_planjeagenda_NOVENUE')?></button>
            </div>
        </td>
    </tr>
</table>
...
<table class="table table-striped" id="articleList">
    <thead>
        <tr>
            <th class="center" style="width: 7px;"><?php echo Text::_('com_planjeagenda_NUM'); ?></th>
            <th style="text-align: left;" class="title"><?php echo HTMLHelper::_('grid.sort', 'com_planjeagenda_VENUE', 'l.venue', $this->lists['order_Dir'], $this->lists['order'], 'venueelement' ); ?></th>
            <th style="text-align: center;" class="title"><?php echo Text::_('com_planjeagenda_COLOR') ?></th>
            <th style="text-align: left;" class="title"><?php echo HTMLHelper::_('grid.sort', 'com_planjeagenda_CITY', 'l.city', $this->lists['order_Dir'], $this->lists['order'], 'venueelement' ); ?></th>
            <th style="text-align: left;" class="title"><?php echo HTMLHelper::_('grid.sort', 'com_planjeagenda_STATE', 'l.state', $this->lists['order_Dir'], $this->lists['order']); ?></th>
            <th style="text-align: left;" class="title center"><?php echo Text::_('com_planjeagenda_COUNTRY'); ?></th>
        </tr>
    </thead>
