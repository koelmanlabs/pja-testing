CREATE TABLE IF NOT EXISTS `#__pja_events` (
    ...
    KEY `idx_dates` (`dates`),
    KEY `idx_recurrence` (`recurrence_type`,`recurrence_first_id`),
    KEY `idx_pub_dates` (`published`,`dates`),
    KEY `idx_pub_featured` (`published`,`featured`),
    KEY `idx_pub_catid` (`published`,`catid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS `#__pja_venues` (
    `id` int(11) unsigned NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `#__pja_categories` (
    `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__pja_cats_event_relations` (
    `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
    `catid` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `#__pja_register` (
    `id` int(11) unsigned NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `#__pja_groups` (
    `id` int(11) unsigned NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `#__pja_groupmembers` (
    `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__pja_config` (
...
CREATE TABLE IF NOT EXISTS `#__pja_attachments` (
    `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__pja_countries` (
    `id` int(11) unsigned NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `#__pja_villages` (
...
ADD COLUMN `village_id` int(11) NOT NULL DEFAULT 0 AFTER `id`,
ADD KEY `idx_village_id` (`village_id`);


INSERT IGNORE INTO `#__pja_config` (`keyname`, `value`) VALUES
('oldevent', '2'),
('minus', '1'),
('showtime', '1'),
('showtitle', '1'),
...
('weekdaystart', '1'),
('ical_tz', '1'),
('attachments_path', 'media/com_planjeagenda/attachments'),
...
('ical_max_items', '100'),
('defaultCountry', ''),
('flagicons_path', 'media/com_planjeagenda/images/flags/w80-webp/'),
('csv_separator', ';'),
('csv_delimiter', '"'),
('csv_bom', '1'),
('globalattribs', ''),
...
INSERT IGNORE INTO `#__pja_countries` (`id`, `continent`, `iso2`, `iso3`, `un`, `name`) VALUES
...
INSERT IGNORE INTO `#__pja_categories` (`id`, `parent_id`, `lft`, `rgt`, `level`, `catname`, `alias`, `access`, `published`, `created_time`, `path` ) VALUES
