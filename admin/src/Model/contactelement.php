...
class ContactelementModel extends BaseDatabaseModel
{
    ///**
    // * Category data array
    // *
    ...
    public function __construct()
    {
        ...
        $limit      = $app->getUserStateFromRequest( 'com_planjeagenda.limit', 'limit', $app->get('list_limit'), 'int');
        $limitstart = $app->getUserStateFromRequest( 'com_planjeagenda.limitstart', 'limitstart', 0, 'int' );
    ...
    protected function buildQuery()
    {
        ...
        $filter_order     = $app->getUserStateFromRequest( 'com_planjeagenda.contactelement.filter_order','filter_order','con.ordering','cmd');
        $filter_order_Dir = $app->getUserStateFromRequest( 'com_planjeagenda.contactelement.filter_order_Dir','filter_order_Dir','','word' );
        ...
        $filter_type      = $app->getUserStateFromRequest('com_planjeagenda.contactelement.filter_type','filter_type',0,'int');
