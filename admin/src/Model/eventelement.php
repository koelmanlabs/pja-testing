...
class EventelementModel extends BaseDatabaseModel
{
    ...
    protected function _buildQuery()
    {
        ...
        $query = 'SELECT a.*, loc.venue, loc.city,c.catname'
               ...
               . ' LEFT JOIN #__pja_cats_event_relations AS rel ON rel.itemid = a.id'
               . ' LEFT JOIN #__pja_categories AS c ON c.id = rel.catid'
               . $where
               . ' GROUP BY a.id'
               . $orderby
               ;
    ...
    public function getCategories($id)
    {
        $query = 'SELECT DISTINCT c.id, c.catname, c.checked_out AS cchecked_out'
               ...
               . ' LEFT JOIN #__pja_cats_event_relations AS rel ON rel.catid = c.id'
