...
class CssmanagerModel extends BaseDatabaseModel
{
    ...
    public function getFiles()
    {
        ...
        $path = Path::clean(JPATH_ROOT.'/media/com_planjeagenda/');
        ...
        if (is_dir($path)) {
            ...
            $this->setError(Text::_('com_planjeagenda_CSSMANAGER_ERROR_CSS_FOLDER_NOT_FOUND'));
            return false;
        }

        # define array with custom css files
        $settings = \PlanjeagendaHelper::retrieveCss();
