...
class JFormFieldCatOptions extends ListField
{
    ...
    public function getInput()
    {
        ...
        // FIX 1: gebruik $this->value als het form-systeem het al heeft geladen
        // (vanuit EventModel::getItem -> $item->cats). Val terug op DB-query
        // als fallback, zodat het field ook standalone werkt.
        if (!empty($this->value) && is_array($this->value)) {
            // Form-systeem heeft de waarde al gebonden (array van cat-IDs)
