...
class JFormFieldModal_Contact extends FormField
{
    ...
    protected function getInput()
    {
        ...
        $html = array();
        $link = 'index.php?option=com_planjeagenda&amp;view=contactelement&amp;tmpl=component&amp;function=jSelectContact_'.$this->id;
        ...
        if (empty($contact)) {
            $contact = Text::_('com_planjeagenda_SELECTCONTACT');
        }
        ...
        $html[] ='<button type="button" class="btn btn-link btn-primary"  data-bs-toggle="modal" data-bs-target="#contact-modal">'.Text::_('com_planjeagenda_SELECT').'
        </button>';
        $html[] = '  </div>';
        $html[] = '</div>';
