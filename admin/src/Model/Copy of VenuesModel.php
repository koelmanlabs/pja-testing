...
class VenuesModel extends ListModel
{
    ...
    protected function getListQuery()
    {
        ...
        $query->join('LEFT OUTER', '#__pja_events AS e ON e.locid = a.id');
        $query->group('a.id');
        ...
        $allowed_venue_cols = ['a.id','a.venue','a.city','a.state','a.country','a.published','a.access','a.created_by'];
        $orderCol = PlanjeagendaHelper::sanitizeOrderCol($orderCol, $allowed_venue_cols, 'a.venue');
        $_allowed = ['a.venue','a.city','a.state','a.country','a.published','a.access','a.ordering','a.created_by'];
        $orderCol = PlanjeagendaHelper::sanitizeOrderCol($orderCol, $_allowed, 'a.venue');
