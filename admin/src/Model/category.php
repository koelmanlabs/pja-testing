...
class CategoryModel extends AdminModel
{
     ...
     */
    public function getTable($type = 'Category', $prefix = 'PlanjeagendaTable', $config = array())
    {
    ...
    {
        PlanjeagendaDebug::log('category save', 'id=' . ($data['id'] ?? 'new') . ' name=' . ($data['catname'] ?? ''));
    ...
    public function delete(&$cids)
    {
        ...
        $query = 'SELECT c.id, c.catname, COUNT( e.catid ) AS numcat'
               ...
               . ' LEFT JOIN #__pja_cats_event_relations AS e ON e.catid = c.id'
