...
class HousekeepingModel extends BaseDatabaseModel
{
    const EVENTS = 1;
    const VENUES = 2;
    const CATEGORIES = 3;
    ...
    public function __construct()
    {
        ...
        $map = array();
        $map[PlanjeagendaModelHousekeeping::EVENTS] = array("folder" => "events", "table" => "events", "field" => "datimage");
        $map[PlanjeagendaModelHousekeeping::VENUES] = array("folder" => "venues", "table" => "venues", "field" => "locimage");
        $map[PlanjeagendaModelHousekeeping::CATEGORIES] = array("folder" => "categories", "table" => "categories", "field" => "image");
        $this->map = $map;
    }
    ...
    public function truncateAllData()
    {
        ...
        $categoryTable = $this->getTable('category', 'PlanjeagendaTable');
    ...
    {
        $query = 'SELECT '.$this->map[$type]['field'].' FROM #__pja_'.$this->map[$type]['table'];
    ...
    private function getAvailable($type)
    {
        ...
        $basePath = JPATH_SITE.'/images/klevents/'.$this->map[$type]['folder'];
