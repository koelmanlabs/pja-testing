...
class CategoriesModel extends ListModel
{
    ...
    protected function populateState($ordering = null, $direction = null)
    {
        ...
        $extension = $app->getUserStateFromRequest('com_planjeagenda.categories.filter.extension', 'extension', 'com_planjeagenda', 'cmd');
    ...
    public function getItems()
    {
        ...
        PlanjeagendaDebug::log('categories model getItems', 'count=' . count($items));
