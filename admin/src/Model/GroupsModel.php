...
class GroupsModel extends ListModel
{
    ...
    protected function getListQuery()
    {
        ...
        $query->from($db->quoteName('#__pja_groups').' AS a');
        ...
        //}
        $allowed_group_cols = ['a.id','a.name','a.published'];
        $orderCol = PlanjeagendaHelper::sanitizeOrderCol($orderCol, $allowed_group_cols, 'a.name');
        $_allowed = ['a.name','a.published','a.access'];
        $orderCol = PlanjeagendaHelper::sanitizeOrderCol($orderCol, $_allowed, 'a.name');
    ...
    public function delete($cid = array())
    {
        if (is_array($cid) && count($cid))
        {
            ...
            $query = 'DELETE FROM #__pja_groups'
                   . ' WHERE id IN ('. $cids .')'
                   ;
            ...
            $query = 'DELETE FROM #__pja_groupmembers'
