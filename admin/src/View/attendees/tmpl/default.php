...
');
?>
<form action="<?php echo Route::_('index.php?option=com_planjeagenda&view=attendees&eventid='.$this->event->id); ?>"  method="post" name="adminForm" id="adminForm">
        ...
        <fieldset id="filter-bar" class="mb-3">
            <div class="row">
                <div class="col-md-11">
                     <div class="row mb-12">
                            <div class="col-md-2">
                                   <strong><?php echo Text::_('com_planjeagenda_DATE').':'; ?></strong>&nbsp;<?php echo $this->event->dates; ?><br>
                            </div>
                            <div class="col-md-2">
                                <strong><?php echo Text::_('com_planjeagenda_EVENT_TITLE').':'; ?></strong>&nbsp;<?php echo $this->escape($this->event->title); ?>
                            </div>
                     </div>
                </div>
                <div class="col-md-1">
        ...
        <table class="table table-striped" id="attendeeList">
            <thead>
                <tr>
                    ...
                    <th class="title center"><?php echo HTMLHelper::_('grid.sort', 'com_planjeagenda_ATTENDEES_PLACES', 'r.waiting',$listDirn, $listOrder); ?></th>
                    <?php if (!empty($this->jemsettings->regallowcomments)) : ?>
                    <th class="title"><?php echo Text::_('com_planjeagenda_COMMENT'); ?></th>
                    <?php endif;?>
                    <th class="title center"><?php echo Text::_('com_planjeagenda_REMOVE_USER'); ?></th>
                    <th style="width: 1%" class="center nowrap"><?php echo HTMLHelper::_('grid.sort', 'com_planjeagenda_ATTENDEES_REGID', 'r.id', $listDirn, $listOrder ); ?></th>
                </tr>
            </thead>
                ...
                <tr class="row<?php echo $i % 2; ?>">
                    ...
                    <td class="center">
                        ...
                        if($this->event->waitinglist) {
                            ...
                            echo PlanjeagendaHtml::toggleAttendanceStatus($i, $status, $canChange);
                        } else {
                            echo PlanjeagendaHtml::toggleAttendanceStatus($i, $status, false);
                        }
                        ?>
                    </td>
                    <td class="center">
                    ...
                    <td class="center">
                        <a href="javascript: void(0);" onclick="return Joomla.listItemTask('cb<?php echo $i;?>','attendees.remove')">
                            <?php echo HTMLHelper::_('image','com_planjeagenda/publish_r.webp',Text::_('com_planjeagenda_REMOVE'),NULL,true); ?>
                        </a>
                    </td>
                    <td class="center">
