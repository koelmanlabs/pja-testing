...
<div class="width-50 fltlft">
    <div class="width-100" style="padding: 10px 1vw;">
        <fieldset class="options-form">
            <legend><?php echo Text::_('com_planjeagenda_USER_CONTROL'); ?></legend>
    ...
    <div class="width-100" style="padding: 10px 1vw;">
        <fieldset class="options-form">
            <legend><?php echo Text::_('com_planjeagenda_AC_EVENTS'); ?></legend>
            <ul class="adminformlist">
...
<div class="width-50 fltrt">
    <div class="width-100" style="padding: 10px 1vw;">
        <fieldset class="options-form">
            <legend><?php echo Text::_('com_planjeagenda_REGISTRATION'); ?></legend>
            <ul class="adminformlist">
    ...
    <div class="width-100" style="padding: 10px 1vw;">
        <fieldset class="options-form">
            <legend><?php echo Text::_('com_planjeagenda_AC_VENUES'); ?></legend>
            <ul class="adminformlist">
