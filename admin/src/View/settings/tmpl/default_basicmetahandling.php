...
<!--
    ...
    function include_description() {
        document.getElementById("jform_meta_description").value = "<?php echo Text::_( 'com_planjeagenda_META_DESCRIPTION_STANDARD' ); ?>";
    }
-->
</script>
...
<div id="jform_storeip-desc" class="hide-aware-inline-help d-none">
            ...
            <li><?php echo $this->form->getLabel('meta_description'); ?>
                <div style="display: block;">
                    ...
                    <br>
                    <input type="button" value="<?php echo Text::_( 'com_planjeagenda_META_DESCRIPTION_BUTTON' ); ?>" onclick="include_description()" />
                    &nbsp;
                    <span <?php echo PlanjeagendaOutput::tooltip(Text::_('com_planjeagenda_WARNING'), Text::_('com_planjeagenda_META_DESCRIPTION_WARN'), 'error'); ?>>
