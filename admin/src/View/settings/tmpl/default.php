...
$wa = $this->document->getWebAssetManager();
        $wa
            ->useScript('keepalive')
            ->registerStyle('planjeagenda.colorpicker', 'com_planjeagenda/colorpicker.css')->useStyle('planjeagenda.colorpicker')
...
<form action="<?php echo Route::_('index.php?option=com_planjeagenda&view=settings'); ?>" method="post" id="settings-form" name="adminForm" class="form-validate">
    ...
    <div id="j-main-container" class="j-main-container">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php echo HTMLHelper::_('uitab.addTab', 'settings-pane', 'settings-basic', Text::_('com_planjeagenda_BASIC_SETTINGS')); ?>
                    ...
                    <?php echo HTMLHelper::_('uitab.addTab','settings-pane', 'event-settings', Text::_('com_planjeagenda_EVENT_PAGE')); ?>
                        <fieldset class="adminform">
                    ...
                    <?php echo HTMLHelper::_('uitab.addTab', 'settings-pane', 'venue-settings', Text::_('com_planjeagenda_VENUE_PAGE')); ?>
                    <fieldset class="adminform">
                    ...
                    <?php echo HTMLHelper::_('uitab.addTab', 'settings-pane', 'layout', Text::_('com_planjeagenda_LAYOUT')); ?>
                        <fieldset class="adminform">
                    ...
                    <?php echo HTMLHelper::_('uitab.addTab', 'settings-pane', 'parameters', Text::_('com_planjeagenda_GLOBAL_PARAMETERS')); ?>
                        <fieldset class="adminform">
                    ...
                    <?php echo HTMLHelper::_('uitab.addTab', 'settings-pane', 'usercontrol', Text::_('com_planjeagenda_USER_CONTROL')); ?>
                        <fieldset class="adminform">
                    ...
                    <?php echo HTMLHelper::_('uitab.addTab', 'settings-pane', 'configinfo', Text::_('com_planjeagenda_SETTINGS_TAB_CONFIGINFO')); ?>
                        <fieldset class="adminform">
                           <?php echo $this->loadTemplate('configinfo'); ?>
                        </fieldset>
                    <?php echo HTMLHelper::_('uitab.endTab'); ?>

                    <?php echo HTMLHelper::_('uitab.addTab', 'settings-pane', 'debug', Text::_('com_planjeagenda_SETTINGS_DEBUG_LABEL')); ?>
