...
<div class="width-50 fltlft">
    <div class="width-100" style="padding: 10px 1vw;">
        <fieldset class="options-form">
            <legend><?php echo Text::_('com_planjeagenda_GLOBAL_PARAMETERS'); ?></legend>
    ...
    <div class="width-100" style="padding: 10px 1vw;">
        <fieldset class="options-form">
            <legend><?php echo Text::_('com_planjeagenda_SETTINGS_LEGEND_VIEW_EDITEVENT'); ?></legend>
            <ul class="adminformlist">
    ...
    <div class="width-100" style="padding: 10px 1vw;">
        <fieldset class="options-form">
            <legend><?php echo Text::_('com_planjeagenda_SETTINGS_LEGEND_VIEW_EDITVENUE'); ?></legend>
            <ul class="adminformlist">
...
<div class="width-50 fltrt">
    <div class="width-100" style="padding: 10px 1vw;">
        <fieldset class="options-form">
            <legend><?php echo Text::_('com_planjeagenda_GLOBAL_PARAMETERS_ADVANCED'); ?></legend>
            <ul class="adminformlist">
    ...
    <div class="width-100" style="padding: 10px 1vw;">
        <fieldset class="options-form">
            <legend><?php echo Text::_('com_planjeagenda_SETTINGS_GLOBAL_RECURRENCE'); ?></legend>
            <ul class="adminformlist">
