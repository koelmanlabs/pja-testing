    ...
    <div class="row">
            <div class="col-md-7">
                <!-- <div class="width-55 fltlft"> -->
                    ...
                    <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'group-info', Text::_('com_planjeagenda_GROUP_INFO_TAB')); ?>
                    <fieldset class="adminform">
                        <legend>
                            <?php echo empty($this->item->id) ? Text::_('com_planjeagenda_NEW_GROUP') : Text::sprintf('com_planjeagenda_GROUP_DETAILS', $this->item->id); ?>
                        </legend>
                    ...
                    <fieldset class="adminform">
                        <table class="adminform" style="width: 100%">
                            <tr>
                                <td><b><?php echo Text::_('com_planjeagenda_GROUP_AVAILABLE_USERS').':'; ?></b></td>
                                <td>&nbsp;</td>
                                <td><b><?php echo Text::_('com_planjeagenda_GROUP_MAINTAINERS').':'; ?></b></td>
                            </tr>
                            <tr>
                    ...
                    <div class="accordion" id="accordionGroupForm">
                        <div class="accordion-item">
                                <h2 class="accordion-header" id="group-permission-header">
                                    ...
                                    <?php echo Text::_('com_planjeagenda_GROUP_PERMISSIONS'); ?>
                                    </button>
                                </h2>
