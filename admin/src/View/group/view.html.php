 ...
 *
 */
class PlanjeagendaViewGroup extends PlanjeagendaAdminView
{
    protected $form;
    protected $item;
    protected $state;
    ...
    public function display($tpl = null)
    {
        ...
        $this->settings    = PlanjeagendaAdmin::config();
    ...
    protected function addToolbar()
    {
        ...
        ToolBarHelper::help('editgroup', true, 'https://www.koelmanlabs.nl/documentation/manual/backend/groups/add-group');
    }
}
?>
