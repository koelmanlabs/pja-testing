 ...
 *
 */
class PlanjeagendaViewContactelement extends HtmlView {
    ...
    public function display($tpl = null)
    {
        ...
        //get vars
        $filter_order        = $app->getUserStateFromRequest('com_planjeagenda.contactelement.filter_order', 'filter_order', 'con.name', 'cmd');
        ...
        //prepare document
        $document->setTitle(Text::_('com_planjeagenda_SELECTVENUE'));
        ...
        $filters[] = HTMLHelper::_('select.option', '2', Text::_('com_planjeagenda_ADDRESS'));
