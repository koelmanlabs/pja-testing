 ...
 * Venueselect-View
 */
class PlanjeagendaViewVenueelement extends Htmlview {
    ...
    public function display($tpl = null)
    {
        ...
        $filter_search    = $app->getUserStateFromRequest('com_planjeagenda.venueelement.'.$itemid.'.filter_search', 'filter_search', '', 'string');
