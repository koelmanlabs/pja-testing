...
<form action="index.php?option=com_planjeagenda&amp;view=categoryelement&amp;tmpl=component" method="post" name="adminForm" id="adminForm">

<table class="adminform">
    <tr>
        <td style="width: 100%;">
            <input type="text" name="filter_search" id="filter_search" placeholder="<?php echo Text::_('com_planjeagenda_SEARCH');?>" value="<?php echo htmlspecialchars($this->lists['search'], ENT_QUOTES, 'UTF-8'); ?>" class="text_area" onChange="document.adminForm.submit();" />
            ...
            <button type="button" onclick="if (window.parent) window.parent.<?php echo $this->escape($function);?>('', '<?php echo Text::_('com_planjeagenda_SELECT_CATEGORY') ?>');"><?php echo Text::_('com_planjeagenda_GLOBAL_NOCATEGORY')?></button>
        </td>
        <td nowrap="nowrap">
...
<table class="table table-striped" id="articleList">
    <thead>
        <tr>
            ...
            <th style="text-align: left;" class="title"><?php echo HTMLHelper::_('grid.sort','com_planjeagenda_CATEGORY','c.catname',$this->lists['order_Dir'],$this->lists['order']); ?></th>
            <th style="width: 1%" nowrap="nowrap"><?php echo Text::_('com_planjeagenda_ACCESS'); ?></th>
