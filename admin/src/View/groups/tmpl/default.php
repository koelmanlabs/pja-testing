...
<form action="<?php echo Route::_('index.php?option=com_planjeagenda&view=groups'); ?>" method="post" name="adminForm" id="adminForm">
    <div id="j-main-container" class="j-main-container">
                    ...
                    <div class="row mb-12">
                        <div class="col-md-4">
                            <div class="input-group">
                                <input type="text" name="filter_search" id="filter_search" class="form-control" aria-describedby="filter_search-desc" placeholder="<?php echo Text::_('com_planjeagenda_SEARCH');?>" value="<?php echo $this->escape($this->state->get('filter_search')); ?>"  inputmode="search" onChange="document.adminForm.submit();" >
        ...
        <table class="table table-striped" id="articleList">
            ...
            <tr>
                ...
                <th style="width: 30%" class="title"><?php echo HTMLHelper::_('grid.sort', 'com_planjeagenda_GROUP_NAME', 'name', $listDirn, $listOrder ); ?></th>
                <th><?php echo Text::_( 'com_planjeagenda_DESCRIPTION' ); ?></th>
                <th style="width: 1%" class="title"><?php echo HTMLHelper::_('grid.sort', 'com_planjeagenda_ID', 'id', $listDirn, $listOrder ); ?></th>
                </tr>
            </thead>
            ...
            <tbody>
                <?php foreach (($this->items ?? []) as $i => $row) :
                    ...
                    $link         = 'index.php?option=com_planjeagenda&amp;task=group.edit&amp;id='.$row->id;
                ?>
