 ...
 * View class: Attendee
 */
class PlanjeagendaViewAttendee extends HtmlView {
    ...
    protected function addToolbar()
    {
        ...
        if (empty($cid[0])) {
            ToolbarHelper::title(Text::_('com_planjeagenda_ADD_ATTENDEE'), 'users');
        } else {
            ToolbarHelper::title(Text::_('com_planjeagenda_EDIT_ATTENDEE'), 'users');
        }
