...
<form action="<?php echo Route::_('index.php?option=com_planjeagenda&view=attendee'); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
    <fieldset>
        ...
        <table  class="admintable">
            <tr>
                <td class="key">
                    <label for="eventtitle" <?php echo PlanjeagendaOutput::tooltip(Text::_('com_planjeagenda_EVENT'), Text::_('com_planjeagenda_EVENT_DESC')); ?>>
            ...
            <tr>
                <td class="key">
                    <label for="username" <?php echo PlanjeagendaOutput::tooltip(Text::_('com_planjeagenda_USER'), Text::_('com_planjeagenda_USER_DESC')); ?>>
            ...
            <tr>
                <td class="key">
                    <label for="status" <?php echo PlanjeagendaOutput::tooltip(Text::_('com_planjeagenda_STATUS'), Text::_('com_planjeagenda_STATUS_DESC')); ?>>
            ...
            <tr>
                <td class="key">
                    <label for="eventtitle" <?php echo PlanjeagendaOutput::tooltip(Text::_('com_planjeagenda_ATTENDEES_PLACES'), Text::_('com_planjeagenda_ATTENDEES_PLACES_DESC')); ?>>
            ...
            <tr>
                <td class="key" style="vertical-align: baseline;">
                    <label for="comment" <?php echo PlanjeagendaOutput::tooltip(Text::_('com_planjeagenda_COMMENT'), Text::_('com_planjeagenda_COMMENT_DESC')); ?>>
            ...
            <tr>
                <td class="key">
                    <label for="seriesbooking" <?php echo PlanjeagendaOutput::tooltip(Text::_('com_planjeagenda_EDITEVENT_FIELD_BOOKED_SERIES'), Text::_('com_planjeagenda_EDITEVENT_FIELD_BOOKED_SERIES')); ?>>
            ...
            <tr>
                <td class="key">
                    <label for="sendemail" <?php echo PlanjeagendaOutput::tooltip(Text::_('com_planjeagenda_SEND_REGISTRATION_NOTIFICATION_EMAIL'), Text::_('com_planjeagenda_SEND_REGISTRATION_NOTIFICATION_EMAIL_DESC')); ?>>
