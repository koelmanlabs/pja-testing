 ...
 * Venue Controller
 */
class PlanjeagendaControllerVenue extends PlanjeagendaControllerForm
{
    ...
    protected function allowAdd($data = array())
    {
        ...
        if (\Joomla\CMS\Factory::getApplication()->getIdentity()->authorise('core.create', 'com_planjeagenda')) {
            return true;
        }
    ...
    protected function allowEdit($data = array(), $key = 'id')
    {
        ...
        if ($user->authorise('core.edit', 'com_planjeagenda') || ($user->id && $user->id == $created_by && $user->authorise('core.edit.own', 'com_planjeagenda'))) {
            return true;
        }
    ...
    protected function _postSaveHook($model, $validData = array())
    {
        ...
        if ($task == 'save') {
            ...
            \Joomla\CMS\Factory::getApplication()->triggerEvent('onVenueEdited', array($id, $isNew));
