...
<fieldset class="jem_fldst_attachments">
    <legend><?php echo Text::_('com_planjeagenda_EVENT_ATTACHMENTS_TAB'); ?></legend>
    <table class="adminform" id="el-attachments">
        <thead>
        <tr>
            <th style="width:25%"><?php echo Text::_('com_planjeagenda_ATTACHMENT_FILE'); ?></th>
            <th style="width:15%"><?php echo Text::_('com_planjeagenda_ATTACHMENT_NAME'); ?></th>
            <th style="width:40%"><?php echo Text::_('com_planjeagenda_ATTACHMENT_DESCRIPTION'); ?></th>
            <th style="width:20px"><?php echo Text::_('com_planjeagenda_ATTACHMENT_ACCESS'); ?></th>
        ...
        <?php foreach ($this->row->attachments as $file): ?>
            <tr>
                ...
                <td><?php echo PlanjeagendaOutput::removebutton(Text::_('com_planjeagenda_GLOBAL_REMOVE_ATTACHEMENT'), array('id' => 'attach-remove'.$file->id.':'.Session::getFormToken(),'class' => 'attach-remove','title'=>Text::_('com_planjeagenda_GLOBAL_REMOVE_ATTACHEMENT'))); ?></td>
            </tr>
        <?php endforeach; ?>
        <tr>
            <td>
