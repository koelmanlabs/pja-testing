...
/**
 * PlanjeagendaConfig class to handle JEM configuration
 *
 * @package JEM
 */
...
class PlanjeagendaConfig
{
    ...
    /**
     * Returns a reference to the global PlanjeagendaConfig object, only creating it
     * if it doesn't already exist.
     *
     * This method must be invoked as:
     * <pre>$jemConfig = PlanjeagendaConfig::getInstance();</pre>
     *
     * @return  PlanjeagendaConfig  The PlanjeagendaConfig object.
     *
     * @since   2.1.6
     */
...
endif; // class_exists PlanjeagendaConfig
