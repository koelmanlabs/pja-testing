...
$_legacyFile = JPATH_SITE . '/components/com_planjeagenda/controllers/myvenues.php';
if (file_exists($_legacyFile) && !class_exists('PlanjeagendaControllerMyvenues', false)) {
...
/**
 * MyvenuesController — J6 namespaced proxy for PlanjeagendaControllerMyvenues.
 */
class MyvenuesController extends \PlanjeagendaControllerMyvenues
{
