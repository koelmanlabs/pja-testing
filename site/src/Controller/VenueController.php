...
$_legacyFile = JPATH_SITE . '/components/com_planjeagenda/controllers/venue.php';
if (file_exists($_legacyFile) && !class_exists('PlanjeagendaControllerVenue', false)) {
...
/**
 * VenueController — J6 namespaced proxy for PlanjeagendaControllerVenue.
 */
class VenueController extends \PlanjeagendaControllerVenue
{
