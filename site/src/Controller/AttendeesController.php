...
$_legacyFile = JPATH_SITE . '/components/com_planjeagenda/controllers/attendees.php';
if (file_exists($_legacyFile) && !class_exists('PlanjeagendaControllerAttendees', false)) {
...
/**
 * AttendeesController — J6 namespaced proxy for PlanjeagendaControllerAttendees.
 */
class AttendeesController extends \PlanjeagendaControllerAttendees
{
