...
$_legacyFile = JPATH_SITE . '/components/com_planjeagenda/controllers/mailto.php';
if (file_exists($_legacyFile) && !class_exists('PlanjeagendaControllerMailto', false)) {
...
/**
 * MailtoController — J6 namespaced proxy for PlanjeagendaControllerMailto.
 */
class MailtoController extends \PlanjeagendaControllerMailto
{
