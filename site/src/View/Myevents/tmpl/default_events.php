...
<form action="<?php echo htmlspecialchars($this->action); ?>" method="post" id="adminForm" name="adminForm">
    ...
    <div class="table-responsive">
        <table class="eventtable table klevents-myevents table-striped" style="width:<?php echo $this->jemsettings->tablewidth; ?>;" summary="klevents">
            <colgroup>
            ...
            <thead>
                <tr>
                    ...
                    <?php endif; ?>
                    <?php if ($this->params->get('displayattendeecolumn') == 1) : ?>
                    <th id="jem_atte" class="sectiontableheader" style="text-align: center;"><?php echo \Text::_('com_planjeagenda_TABLE_ATTENDEES'); ?></th>
                    <?php endif; ?>
                    ...
                    <?php foreach ($this->events as $i => $row) : ?>
                        <tr class="row<?php echo $i % 2 . ' event_id' . $this->escape($row->id); ?>">
                            ...
                            <td headers="jem_date" style="text-align: left;">
                                <?php echo \PlanjeagendaOutput::formatShortDateTime($row->dates, $row->times, $row->enddates, $row->endtimes, $this->jemsettings->showtime); ?>
                            </td>
                            ...
                            <td headers="jem_title" style="text-align: left; vertical-align: top;">
                                <a href="<?php echo \Route::_(\PlanjeagendaHelperRoute::getEventRoute($row->slug)); ?>">
                                    <?php echo $this->escape($row->title) . \PlanjeagendaOutput::recurrenceicon($row); ?>
                                </a>
                            </td>
                            <?php endif; ?>
                            ...
                            <td headers="jem_atte" style="text-align: center; vertical-align: top;">
                                ...
                                if ($this->jemsettings->showfroregistra || ($row->registra & 1)) {
                                    ...
                                    echo \HTMLHelper::_('image', 'com_planjeagenda/publish_r.webp',NULL,NULL,true);
                                }
                                ?>
                            </td>
                            <?php endif; ?>
