...
<?php if (!empty($attachments)): ?>
    ...
    <?php foreach ($attachments as $att):
        ...
        $filePath = $baseUrl . $this->jemsettings->attachments_path . '/event' . (int)$this->item->id . '/' . $att->file;
    ?>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const pondInput = document.getElementById('pja-filepond-event');
