...
namespace KoelmanLabs\Component\Planjeagenda\Site\View\Day;
...
class HtmlView extends BaseHtmlView
{
    ...
    public function display($tpl = null)
    {
        ...
        // get variables
        $filter_order     = $app->getUserStateFromRequest('com_planjeagenda.day.'.$itemid.'.filter_order', 'filter_order', 'a.dates', 'cmd');
        $filter_order_Dir = $app->getUserStateFromRequest('com_planjeagenda.day.'.$itemid.'.filter_order_Dir', 'filter_order_Dir', '', 'word');
        $filter_type      = $app->getUserStateFromRequest('com_planjeagenda.day.'.$itemid.'.filter_type', 'filter_type', 0, 'int');
        ...
        $daydate     = \PlanjeagendaOutput::formatdate($day);
      ...
      //$pathway->setItemName(1, $menuitem->title);
            ...
            $pagetitle   = Text::_('com_planjeagenda_DEFAULT_PAGE_TITLE_DAY');
        ...
        if ($requestVenueId){
            $print_link = Route::_('index.php?option=com_planjeagenda&view=day&tmpl=component&print=1&locid='.$requestVenueId.'&id='.$requestDate);
        }
        elseif ($requestCategoryId){
            $print_link = Route::_('index.php?option=com_planjeagenda&view=day&tmpl=component&print=1&catid='.$requestCategoryId.'&id='.$requestDate);
        }
        else /*(!$requestCategoryId && !$requestVenueId)*/ {
            $print_link = Route::_('index.php?option=com_planjeagenda&view=day&tmpl=component&print=1&id='.$requestDate);
        }
        ...
        $link    = 'index.php?option=com_planjeagenda&view=day&format=feed';
