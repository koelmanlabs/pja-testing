...
<form action="<?php echo htmlspecialchars($this->action); ?>" method="post" id="adminForm" name="adminForm">
    ...
    <div id="jem_filter" class="floattext">
        ...
        <div class="jem_fleft">
            <label for="filter"><?php echo \Text::_('com_planjeagenda_FILTER'); ?></label>
    ...
    <div class="table-responsive">
        <table class="eventtable table klevents-myattendees table-striped" style="width:<?php echo $this->jemsettings->tablewidth; ?>;" summary="Attending">
            <colgroup>
            ...
            <thead>
                <tr>
                    <th id="jem_date" class="sectiontableheader" style="text-align: left;"><?php echo \HTMLHelper::_('grid.sort', 'com_planjeagenda_TABLE_DATE', 'a.dates', $this->lists['order_Dir'], $this->lists['order']); ?></th>
                    <?php if ($this->jemsettings->showtitle == 1) : ?>
                    <th id="jem_title" class="sectiontableheader" style="text-align: left;"><?php echo \HTMLHelper::_('grid.sort', 'com_planjeagenda_TABLE_TITLE', 'a.title', $this->lists['order_Dir'], $this->lists['order']); ?></th>
                    <?php endif; ?>
                    <?php if ($this->jemsettings->showlocate == 1) : ?>
                    <th id="jem_location" class="sectiontableheader" style="text-align: left;"><?php echo \HTMLHelper::_('grid.sort', 'com_planjeagenda_TABLE_LOCATION', 'l.venue', $this->lists['order_Dir'], $this->lists['order']); ?></th>
                    <?php endif; ?>
                    <?php if ($this->jemsettings->showcity == 1) : ?>
                    <th id="jem_city" class="sectiontableheader" style="text-align: left;"><?php echo \HTMLHelper::_('grid.sort', 'com_planjeagenda_TABLE_CITY', 'l.city', $this->lists['order_Dir'], $this->lists['order']); ?></th>
                    <?php endif; ?>
                    <?php if ($this->jemsettings->showstate == 1) : ?>
                    <th id="jem_state" class="sectiontableheader" style="text-align: left;"><?php echo \HTMLHelper::_('grid.sort', 'com_planjeagenda_TABLE_STATE', 'l.state', $this->lists['order_Dir'], $this->lists['order']); ?></th>
                    <?php endif; ?>
                    <?php if ($this->jemsettings->showcat == 1) : ?>
                    <th id="jem_category" class="sectiontableheader" style="text-align: left;"><?php echo \HTMLHelper::_('grid.sort', 'com_planjeagenda_TABLE_CATEGORY', 'c.catname', $this->lists['order_Dir'], $this->lists['order']); ?></th>
                    <?php endif; ?>
                    <th id="jem_category" class="sectiontableheader" style="text-align: left;"><?php echo \HTMLHelper::_('grid.sort', 'com_planjeagenda_TABLE_PLACES', 'r.places', $this->lists['order_Dir'], $this->lists['order']); ?></th>
                       <th id="jem_status" class="sectiontableheader center" style="text-align: left;"><?php echo \HTMLHelper::_('grid.sort', 'com_planjeagenda_STATUS', 'r.status', $this->lists['order_Dir'], $this->lists['order']); ?></th>
                    <?php if (!empty($this->jemsettings->regallowcomments)) : ?>
                    <th id="jem_comment" class="sectiontableheader" style="text-align: left;"><?php echo \Text::_('com_planjeagenda_COMMENT'); ?></th>
                    <?php endif; ?>
                </tr>
            </thead>
            ...
            <?php if (empty($this->attending)) : ?>
                <tr class="no_events"><td colspan="20"><?php echo \Text::_('com_planjeagenda_NO_EVENTS'); ?></td></tr>
            <?php else : ?>
                <?php $odd = 0; ?>
                <?php foreach ($this->attending as $row) : ?>
                    ...
                    <?php endif; ?>
                        ...
                        <td headers="jem_title" style="text-align: left; vertical-align: top;">
                            <a href="<?php echo \Route::_(\PlanjeagendaHelperRoute::getEventRoute($row->slug)); ?>" itemprop="url">
                                <span itemprop="name"><?php echo $this->escape($row->title) . \PlanjeagendaOutput::recurrenceicon($row); ?></span>
                            </a><?php echo \PlanjeagendaOutput::publishstateicon($row); ?>
                        </td>
                        <?php endif; ?>
                        ...
                        <td headers="jem_location" style="text-align: left; vertical-align: top;">
                            ...
                            if (!empty($row->venue)) :
                                if (($this->jemsettings->showlinkvenue == 1) && !empty($row->venueslug)) :
                                    echo "<a href='".\Route::_(\PlanjeagendaHelperRoute::getVenueRoute($row->venueslug))."'>".$this->escape($row->venue)."</a>";
                                else :
