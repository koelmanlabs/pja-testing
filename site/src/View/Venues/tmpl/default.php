...
?>
<div id="klevents" class="jem_venues<?php echo $this->pageclass_sfx . ' venues_id' . $this->item->id; ?>">
    <div class="buttons">
        <?php
    ...
    <?php foreach($this->rows as $row) : ?>
        ...
        <div itemscope itemtype="https://schema.org/Place" class="venue_id<?php echo $this->escape($row->locid); ?>">
            ...
            <!-- FLYER -->
            <?php echo \PlanjeagendaOutput::flyer( $row, $row->limage, 'venue' ); ?>
            ...
            <dl class="location">
                ...
                <dt class="venue_website">
                    <?php echo \Text::_('com_planjeagenda_WEBSITE').':'; ?>
                </dt>
            ...
            <dl class="location floattext" itemprop="address" itemscope itemtype="https://schema.org/PostalAddress">
                ...
                <dt class="venue_street">
                    <?php echo \Text::_('com_planjeagenda_STREET').':'; ?>
                </dt>
                ...
                <dt class="venue_postalCode">
                    <?php echo \Text::_('com_planjeagenda_ZIP').':'; ?>
                </dt>
                ...
                <?php if ($row->city) : ?>
                <dt class="venue_city">
                    <?php echo \Text::_('com_planjeagenda_CITY').':'; ?>
                </dt>
                ...
                <dt class="venue_state">
                    <?php echo \Text::_('com_planjeagenda_STATE').':'; ?>
                </dt>
                ...
                <dt class="venue_country">
                    <?php echo \Text::_('com_planjeagenda_COUNTRY').':'; ?>
                </dt>
                <dd class="venue_country">
                    <?php if ($row->country) :
                        $countryimg = PlanjeagendaHelperCountries::getCountryFlag($row->country);
                ...
                <?php if ($this->settings->get('global_show_mapserv') == 1 || $this->settings->get('global_show_mapserv') == 4) : ?>
                    <?php echo \PlanjeagendaOutput::mapicon($row,null,$this->settings); ?>
                <?php endif; ?>
            </dl>
            ...
            <dl class="floattext">
                <dt class="venue_eventspublished">
                    <?php echo \Text::_('com_planjeagenda_VENUES_EVENTS_PUBLISHED').':'; ?>
                </dt>
            ...
            <dl class="floattext">
                <dt class="venue_archivedevents">
                    <?php echo \Text::_('com_planjeagenda_VENUES_EVENTS_ARCHIVED').':'; ?>
                </dt>
            ...
            <?php if ($this->settings->get('global_show_mapserv')== 3) : ?>
                ...
                <?php echo \PlanjeagendaOutput::mapicon($row,'venues',$this->settings); ?>
            <?php endif; ?>

            <?php if ($this->settings->get('global_show_locdescription',1) && $row->locdescription != '' && $row->locdescription != '<br>') : ?>
            <h2 class="description">
                <?php echo \Text::_('com_planjeagenda_VENUE_DESCRIPTION').':'; ?>
            </h2>
