...
<style>
  ...
  #klevents.jem_myvenues .klevents-myvenues-check {
    flex: 0 1%;
  }

  #klevents.jem_myvenues .klevents-myvenues-status {
    flex: 0 1%;
  }
</style>
  ...
  <?php endif; ?>
    ...
    <div class="klevents-list-row klevents-small-list">
      <?php if (empty($this->print) && !empty($this->permissions->canPublishVenue)) : ?>
                <div class="sectiontableheader klevents-myvenues-check">
      ...
      <?php endif; ?>
      <div class="klevents-myvenues-status" ><?php echo \Text::_('JSTATUS'); ?></div>
    </div>
  </div>
    ...
    <ul class="eventlist">
        ...
        <?php if (!empty($row->featured)) :   ?>
          <li class="klevents-event klevents-list-row klevents-small-list klevents-featured event-id<?php echo $row->id.$this->params->get('pageclass_sfx') . ' venue_id' . $this->escape($row->id); ?>" itemscope="itemscope" itemtype="https://schema.org/Event">
                <?php else : ?>
          <li class="klevents-event klevents-list-row klevents-small-list klevents-odd<?php echo ($i % 2) . $this->params->get('pageclass_sfx') . ' venue_id' . $this->escape($row->id); ?>" itemscope="itemscope" itemtype="https://schema.org/Event">
                <?php endif; ?>
            ...
            <?php endif; ?>
                    ...
                    <div class="klevents-event-info-small klevents-myvenues-status">
