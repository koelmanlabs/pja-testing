...
<?php if (!$this->params->get('show_page_heading', 1)) : /* hide this if page heading is shown */ ?>
    <h2><?php echo \Text::_('com_planjeagenda_MY_VENUES'); ?></h2>
<?php endif; ?>
...
<form action="<?php echo htmlspecialchars($this->action); ?>" method="post" id="adminForm" name="adminForm">
    ...
    <div class="table-responsive">
        <table class="eventtable klevents-myvenues" style="width:<?php echo $this->jemsettings->tablewidth; ?>;" summary="Venues">
            <colgroup>
            ...
            <tbody>
                <?php if (empty($this->venues)) : ?>
                    <tr class="no_events"><td colspan="20"><?php echo \Text::_('com_planjeagenda_NO_VENUES'); ?></td></tr>
                <?php else : ?>
