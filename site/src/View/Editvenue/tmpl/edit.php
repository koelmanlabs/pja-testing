        ...
        <form action="<?php echo \Route::_('index.php?option=com_planjeagenda&a_id=' . (int)$this->item->id); ?>" class="form-validate" method="post" name="adminForm" id="venue-form" enctype="multipart/form-data">
            ...
            if ($global_show_mapserv == 2 || $global_show_mapserv == 3 || $global_show_mapserv == 5) : ?>
                <fieldset class="adminform" id="geodata">
                    ...
                    <div class="clr"></div>
                    <div id="mapdiv">
                        <input id="geocomplete" type="text" size="55" placeholder="<?php echo \Text::_( 'com_planjeagenda_VENUE_ADDRPLACEHOLDER' ); ?>" value="" />
                        <input id="find-left" class="geobutton" type="button" value="<?php echo \Text::_('com_planjeagenda_VENUE_ADDR_FINDVENUEDATA'); ?>" />
                        <div class="clr"></div>

                        <div class="map_canvas"></div>

                        <ul class="adminformlist label-button-line">
                            <li><label><?php echo \Text::_('com_planjeagenda_STREET'); ?></label>
                            ...
                            <li><label><?php echo \Text::_('com_planjeagenda_ZIP'); ?></label>
                                <input type="text" disabled="disabled" class="readonly" id="tmp_form_postalCode" readonly="readonly" />
                            </li>
                            <li><label><?php echo \Text::_('com_planjeagenda_CITY'); ?></label>
                                <input type="text" disabled="disabled" class="readonly" id="tmp_form_city" readonly="readonly" />
                            </li>
                            <li><label><?php echo \Text::_('com_planjeagenda_STATE'); ?></label>
                                <input type="text" disabled="disabled" class="readonly" id="tmp_form_state" readonly="readonly" />
                            </li>
                            <li><label><?php echo \Text::_('com_planjeagenda_VENUE'); ?></label>
                                <input type="text" disabled="disabled" class="readonly" id="tmp_form_venue" readonly="readonly" />
                            </li>
                            <li><label><?php echo \Text::_('com_planjeagenda_COUNTRY'); ?></label>
                                <input type="text" disabled="disabled" class="readonly" id="tmp_form_country" readonly="readonly" />
                            </li>
                            <li><label><?php echo \Text::_('com_planjeagenda_LATITUDE'); ?></label>
                                <input type="text" disabled="disabled" class="readonly" id="tmp_form_latitude" readonly="readonly" />
                            </li>
                            <li><label><?php echo \Text::_('com_planjeagenda_LONGITUDE'); ?></label>
                                <input type="text" disabled="disabled" class="readonly" id="tmp_form_longitude" readonly="readonly" />
                            </li>
                        </ul>

                        <div class="clr"></div>
                        <input id="cp-all"     class="geobutton" type="button" value="<?php echo \Text::_('com_planjeagenda_VENUE_COPY_DATA'); ?>" style="margin-right: 3em;" />
                        <input id="cp-address" class="geobutton" type="button" value="<?php echo \Text::_('com_planjeagenda_VENUE_COPY_ADDRESS'); ?>" />
                        <input id="cp-venue"   class="geobutton" type="button" value="<?php echo \Text::_('com_planjeagenda_VENUE_COPY_VENUE'); ?>" />
                        <input id="cp-latlong" class="geobutton" type="button" value="<?php echo \Text::_('com_planjeagenda_VENUE_COPY_COORDINATES'); ?>" />
                    </div>
                </fieldset>
                <p>&nbsp;</p>
            <?php endif; ?>
            ...
            <?php if (!empty($this->item->attachments) || ($this->jemsettings->attachmentenabled != 0)) : ?>
                ...
                <?php //echo \HTMLHelper::_('tabs.panel', \Text::_('com_planjeagenda_EDITVENUE_ATTACHMENTS_TAB'), 'venue-attachments'); ?>
            ...
            <?php //echo \HTMLHelper::_('tabs.panel', \Text::_('com_planjeagenda_EDITVENUE_OTHER_TAB'), 'venue-other' ); ?>
