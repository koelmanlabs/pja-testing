...
$location = \PlanjeagendaHelper::defineCenterMap($this->form);
?>
...
<div id="klevents" class="jem_editvenue<?php echo $this->pageclass_sfx; ?>">
    <div class="edit item-page">
        ...
        <form action="<?php echo \Route::_('index.php?option=com_planjeagenda&a_id=' . (int) $this->item->id); ?>" class="form-validate" method="post" name="adminForm" id="venue-form" enctype="multipart/form-data">
            ...
            <!--  VENUE-DETAILS TAB -->
            <?php //echo \HTMLHelper::_('tabs.panel', \Text::_('com_planjeagenda_EDITVENUE_INFO_TAB'), 'venue-details'); ?>
            <?php echo \HTMLHelper::_('uitab.startTabSet', 'myTab', ['active' => 'venue-details', 'recall' => true, 'breakpoint' => 768]); ?>
            <?php echo \HTMLHelper::_('uitab.addTab', 'myTab', 'venue-details', \Text::_('com_planjeagenda_EDITVENUE_INFO_TAB')); ?>

            <fieldset>
                <legend><?php echo \Text::_('com_planjeagenda_EDITVENUE_DETAILS_LEGEND'); ?></legend>
            ...
            if ($global_show_mapserv == 2 || $global_show_mapserv == 3 || $global_show_mapserv == 5) : ?>
                <fieldset class="adminform" id="geodata">
                    <legend><?php echo \Text::_('com_planjeagenda_GEODATA_LEGEND'); ?></legend>
                    <dl class="adminformlist klevents-dl">
                        <dt><?php echo $this->form->getLabel('map'); ?></dt>
                        <dd><?php echo $this->form->getInput('map'); ?></dd>
                    </dl>
                    <?php echo \Text::_('com_planjeagenda_ADDRESS_NOTICE'); ?>

                    <div style="clear: both;"></div>

                    <div id="mapdiv">
                        <div class="klevents-row klevents-justify-start">
                            <div><input id="geocomplete" class="form-control" type="text" size="55" placeholder="<?php echo \Text::_('com_planjeagenda_VENUE_ADDRPLACEHOLDER'); ?>" value="" /></div>
                            <div><input id="find-left" class="btn" type="button" value="<?php echo \Text::_('com_planjeagenda_VENUE_ADDR_FINDVENUEDATA'); ?>" /></div>
                        </div>

                        <div class="map_canvas"></div>

                        <dl class="adminformlist klevents-dl">
                            <dt><label><?php echo \Text::_('com_planjeagenda_STREET'); ?></label></dt>
                            <dd>
                            ...
                            <dt><label><?php echo \Text::_('com_planjeagenda_ZIP'); ?></label></dt>
                            <dd><input type="text" disabled="disabled" class="readonly" id="tmp_form_postalCode" readonly="readonly" /></dd>
                            <dt><label><?php echo \Text::_('com_planjeagenda_CITY'); ?></label></dt>
                            <dd><input type="text" disabled="disabled" class="readonly" id="tmp_form_city" readonly="readonly" /></dd>
                            <dt><label><?php echo \Text::_('com_planjeagenda_STATE'); ?></label></dt>
                            <dd><input type="text" disabled="disabled" class="readonly" id="tmp_form_state" readonly="readonly" /></dd>
                            <dt><label><?php echo \Text::_('com_planjeagenda_VENUE'); ?></label></dt>
                            <dd><input type="text" disabled="disabled" class="readonly" id="tmp_form_venue" readonly="readonly" /></dd>
                            <dt><label><?php echo \Text::_('com_planjeagenda_COUNTRY'); ?></label></dt>
                            <dd><input type="text" disabled="disabled" class="readonly" id="tmp_form_country" readonly="readonly" /></dd>
                            <dt><label><?php echo \Text::_('com_planjeagenda_LATITUDE'); ?></label></dt>
                            <dd><input type="text" disabled="disabled" class="readonly" id="tmp_form_latitude" readonly="readonly" /></dd>
                            <dt><label><?php echo \Text::_('com_planjeagenda_LONGITUDE'); ?></label></dt>
                            <dd><input type="text" disabled="disabled" class="readonly" id="tmp_form_longitude" readonly="readonly" /></dd>
                        </dl>

                        <div style="clear: both;"><br></div>
                        <div class="klevents-row klevents-justify-start">
                            <input id="cp-all" class="btn" type="button" value="<?php echo \Text::_('com_planjeagenda_VENUE_COPY_DATA'); ?>" />
                            <input id="cp-address" class="btn" type="button" value="<?php echo \Text::_('com_planjeagenda_VENUE_COPY_ADDRESS'); ?>" />
                            <input id="cp-venue" class="btn" type="button" value="<?php echo \Text::_('com_planjeagenda_VENUE_COPY_VENUE'); ?>" />
                            <input id="cp-latlong" class="btn" type="button" value="<?php echo \Text::_('com_planjeagenda_VENUE_COPY_COORDINATES'); ?>" />
                        </div>
                    </div>
                </fieldset>
                <p>&nbsp;</p>
            <?php endif; ?>
            <fieldset>
                <legend><?php echo \Text::_('com_planjeagenda_EDITVENUE_DESCRIPTION_LEGEND'); ?></legend>
                <div style="clear: both;"><br></div>
                <div>
            ...
            <?php echo \HTMLHelper::_('uitab.addTab', 'myTab', 'editvenue-extendedtab', \Text::_('com_planjeagenda_EDITVENUE_EXTENDED_TAB')); ?>
            <?php //echo \HTMLHelper::_('tabs.panel', \Text::_('com_planjeagenda_EDITVENUE_EXTENDED_TAB'), 'editvenue-extendedtab'); ?>
            <?php echo $this->loadTemplate('extended'); ?>


            <!-- PUBLISHING TAB -->
            <?php echo \HTMLHelper::_('uitab.endTab'); ?>
            <?php echo \HTMLHelper::_('uitab.addTab', 'myTab', 'venue-publishtab', \Text::_('com_planjeagenda_EDITVENUE_PUBLISH_TAB')); ?>
            <?php // echo \HTMLHelper::_('tabs.panel', \Text::_('com_planjeagenda_EDITVENUE_PUBLISH_TAB'), 'venue-publishtab'); ?>
            <?php echo $this->loadTemplate('publish'); ?>

            <!-- ATTACHMENTS TAB -->
            <?php echo \HTMLHelper::_('uitab.endTab'); ?>
            <?php if (!empty($this->item->attachments) || ($this->jemsettings->attachmentenabled != 0)) : ?>
                <?php echo \HTMLHelper::_('uitab.addTab', 'myTab', 'venue-attachments', \Text::_('com_planjeagenda_EDITVENUE_ATTACHMENTS_TAB')); ?>
                <?php //echo \HTMLHelper::_('tabs.panel', \Text::_('com_planjeagenda_EDITVENUE_ATTACHMENTS_TAB'), 'venue-attachmentstab'); ?>
                <?php echo $this->loadTemplate('attachments'); ?>
                <?php echo \HTMLHelper::_('uitab.endTab'); ?>
            <?php endif; ?>

            <!-- MORE TAB -->
            <?php echo \HTMLHelper::_('uitab.addTab', 'myTab', 'venue-other', \Text::_('com_planjeagenda_EDITVENUE_OTHER_TAB')); ?>
            <?php //echo \HTMLHelper::_('tabs.panel', \Text::_('com_planjeagenda_EDITVENUE_OTHER_TAB'), 'venue-othertab'); ?>
