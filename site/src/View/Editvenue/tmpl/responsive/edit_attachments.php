                ...
                <td style="width: 100%;">
                    <dl class="klevents-dl">
                        ...
                        <?php if ($this->jemsettings->attachmentenabled != 0) : ?>
                            ...
                            ?>
                            <dt><?php echo \Text::_('com_planjeagenda_ATTACHMENT_REMOVE') . ' ' . $file->name; ?></dt>
                            <dd><?php echo \PlanjeagendaOutput::removebutton(\Text::_('com_planjeagenda_GLOBAL_REMOVE_ATTACHEMENT'), array('id' => 'attach-remove' . $file->id . ':' . Session::getFormToken(), 'class' => 'attach-remove btn', 'title' => \Text::_('com_planjeagenda_GLOBAL_REMOVE_ATTACHEMENT'))); ?></dd>
                        <?php endif; ?>
                    </dl>
                </td>
                <td>
