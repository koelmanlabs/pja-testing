...
<?php endif; ?>
    ...
    <?php endif; ?>
        ...
        <thead>
            <tr>
                <th id="jem_city" class="sectiontableheader" style="text-align: left;"><i class="fa fa-building" aria-hidden="true"></i>&nbsp;<?php echo \HTMLHelper::_('grid.sort', 'com_planjeagenda_TABLE_CITY', 'a.city', $this->lists['order_Dir'], $this->lists['order']); ?></th>
    <?php if ($this->params->get('showstate')) : ?>
                <th id="jem_state" class="sectiontableheader" style="text-align: left;"><i class="fa fa-map" aria-hidden="true"></i>&nbsp;<?php echo \HTMLHelper::_('grid.sort', 'com_planjeagenda_TABLE_STATE', 'a.state', $this->lists['order_Dir'], $this->lists['order']); ?></th>
    <?php endif; ?>



                <th id="jem_location" class="sectiontableheader" style="text-align: left;"><i class="fa fa-map-marker" aria-hidden="true"></i>&nbsp;<?php echo \HTMLHelper::_('grid.sort', 'com_planjeagenda_TABLE_LOCATION', 'a.venue', $this->lists['order_Dir'], $this->lists['order']); ?></th>
            ...
            <?php else : ?>
                ...
                <?php endif; ?>
                    ...
                    <td headers="jem_location" style="text-align: left; vertical-align: top;">
                        ...
                        echo \PlanjeagendaOutput::publishstateicon($row);
                            echo $venueaccess;
                        ?>
                    </td>
                </tr>
