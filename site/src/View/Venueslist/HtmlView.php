...
namespace KoelmanLabs\Component\Planjeagenda\Site\View\Venueslist;
    ...
    public function __construct($config = array())
{
    ...
    public function display($tpl = null)
    {
        ...
        // get variables
        $filter_order     = $app->getUserStateFromRequest('com_planjeagenda.venueslist.filter_order', 'filter_order',     'a.city', 'cmd');
        $filter_order_Dir = $app->getUserStateFromRequest('com_planjeagenda.venueslist.filter_order_Dir', 'filter_order_Dir',    '', 'word');
//         $filter_state     = $app->getUserStateFromRequest('com_planjeagenda.venueslist.filter_state', 'filter_state',     '*', 'word');
        $filter           = $app->getUserStateFromRequest('com_planjeagenda.venueslist.filter_type', 'filter_type', '', 'int');
        $search           = $app->getUserStateFromRequest('com_planjeagenda.venueslist.filter_search', 'filter_search', '', 'string');
        ...
        //$filters[] = HTMLHelper::_('select.option', '0', Text::_('com_planjeagenda_CHOOSE'));
        ...
        // Set Page title
        $pagetitle = Text::_('com_planjeagenda_VENUESLIST_PAGETITLE');
        ...
        if ($useMenuItemParams) {
            ...
            $pagetitle = $params->get('page_title', Text::_('com_planjeagenda_VENUESLIST_PAGETITLE'));
            $pageheading = $params->get('page_heading', $pagetitle);
            $pageclass_sfx = $params->get('pageclass_sfx');
            $print_link = Route::_('index.php?option=com_planjeagenda&view=venueslist&print=1&tmpl=component');
        }
