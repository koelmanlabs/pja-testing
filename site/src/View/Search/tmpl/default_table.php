    ...
    <div class="jem_fleft">
        <table>
            ...
            <tr>
                ...
                <td>
                    <div class="nowrap"><?php echo \Text::_('com_planjeagenda_SEARCH_FROM'); ?><?php echo $this->lists['date_from'];?></div>
                    <div class="nowrap"><?php echo \Text::_('com_planjeagenda_SEARCH_TO'); ?><?php echo $this->lists['date_to'];?></div>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td colspan="2">
                    <input class="btn btn-primary" type="submit" value="<?php echo \Text::_('com_planjeagenda_SEARCH_SUBMIT'); ?>"/>
                </td>
            </tr>
        </table>
...
<div class="table-responsive">
    <table class="eventtable table table-striped" style="width:<?php echo $this->jemsettings->tablewidth; ?>;" summary="klevents">
        <colgroup>
        ...
        <thead>
            <tr>
                ...
                <?php endif; ?>
                <?php if ($this->jemsettings->showstate == 1) : ?>
                <th id="jem_state" class="sectiontableheader" style="text-align: left;"><?php echo \HTMLHelper::_('grid.sort', 'COM_PLANJEAGENDA_VENUE_PROVINCE_LABEL', 'l.state', $this->lists['order_Dir'], $this->lists['order']); ?></th>
                <?php endif; ?>
                <?php if ($this->jemsettings->showcat == 1) : ?>
        ...
        <tbody>
            <?php if (empty($this->rows)) : ?>
                <tr class="no_events"><td colspan="20"><?php echo \Text::_('com_planjeagenda_NO_EVENTS_FOUND'); ?></td></tr>
            <?php else : ?>
                <?php $odd = 0; ?>
