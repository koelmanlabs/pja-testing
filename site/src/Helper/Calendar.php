    ...
    */
    function mkDay($var) {
        ...
        if ($this->isEvent($var)) {
            ...
            $out = "<td class=\"".implode(' ', $cssClass)."\"><div class=\"daynum\" klevents-monthname=\"".$this->getMonthName()."\" klevents-dayname=\"".$this->getDayName($this->getWeekday($var))."\">".$htmlNewEventLink.$linktext.'</div>'.$eventContent."</td>";
        }
