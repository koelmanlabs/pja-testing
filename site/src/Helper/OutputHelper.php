...
class OutputHelper
{
    ...
    static public function footer()
    {
        ...
        if ($app->input->get('print','','int')) {
            ...
            echo 'Powered by <a href="https://www.koelmanlabs.com" target="_blank" title="Event manager for Joomla">Koelmanlabs.com/Planjeagenda</a>';
        }
    }
        ...
        if ($allowedtoedit) {
            ...
            switch ($view)
            {
                case 'editevent':
                    ...
                    if ($showIcon) {
                        if($item->recurrence_type && !$item->recurrence_first_id){
                            $image = OutputHelper::makeicon('com_planjeagenda/calendar_edit_root.webp', $iconEditEventRoot, Text::_('com_planjeagenda_EDIT_EVENT_ROOT'), NULL, !$app->isClient('site'));
                            $overlib = Text::_('com_planjeagenda_EDIT_EVENT_ROOT_DESC');
                            $text = Text::_('com_planjeagenda_EDIT_EVENT_ROOT');
                        }else {
                            $image = OutputHelper::makeicon('com_planjeagenda/calendar_edit.webp', 'fa fa-fw fa-pen-square klevents-editbutton', Text::_('com_planjeagenda_EDIT_EVENT'), NULL, !$app->isClient('site'));
                ...
                case 'editvenue':
                    ...
                    if ($showIcon) {
                        $image = OutputHelper::makeicon( 'com_planjeagenda/calendar_edit.webp', 'fa fa-fw fa-pen-square klevents-editbutton', Text::_('com_planjeagenda_EDIT_VENUE'), NULL, !$app->isClient('site'));
                    } else {
    ...
    static public function copybutton($item, $params, $attribs, $allowedtoadd, $view)
    {
        if ($allowedtoadd) {
            ...
            switch ($view)
            {
                case 'editevent':
                    if ($showIcon) {
                        $image = OutputHelper::makeicon( 'com_planjeagenda/calendar_copy.webp', 'fas fa-fw fa-copy klevents-copybutton', Text::_('com_planjeagenda_COPY_EVENT'), NULL, !$app->isClient('site'));
                    } else {
                ...
                case 'editvenue':
                    if ($showIcon) {
                        $image = OutputHelper::makeicon( 'com_planjeagenda/calendar_copy.webp', 'fas fa-fw fa-copy klevents-copybutton', Text::_('com_planjeagenda_COPY_VENUE'), NULL, !$app->isClient('site'));
                    } else {
