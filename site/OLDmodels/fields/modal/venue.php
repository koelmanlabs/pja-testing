...
class JFormFieldModal_Venue extends FormField
{
    ...
    protected function getInput()
    {
        ...
        $html = array();
        $link = Uri::base() . 'index.php?option=com_planjeagenda&amp;view=editevent&amp;layout=choosevenue&amp;tmpl=component&amp;function=jSelectVenue_'.$this->id;
        ...
        if (empty($venue)) {
            $venue = Text::_('com_planjeagenda_SELECT_VENUE');
        }
        ...
        $html[] ='<button type="button" class="btn btn-success button-select" data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#venue-modal">'.Text::_('com_planjeagenda_SELECT').'
        </button>';
