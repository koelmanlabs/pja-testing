...
class JFormFieldModal_Contact extends FormField
{
    ...
    protected function getInput()
    {
        ...
        $html = array();
        $link = 'index.php?option=com_planjeagenda&amp;view=editevent&amp;layout=choosecontact&amp;tmpl=component&amp;function=jSelectContact_'.$this->id;
        ...
        if (empty($contact)) {
            $contact = Text::_('com_planjeagenda_SELECT_CONTACT');
        }
        ...
        $html[] ='<button type="button" class="btn btn-success button-select" data-bs-toggle="modal" data-bs-target="#contact-modal">'.Text::_('com_planjeagenda_SELECT').'</button>';
