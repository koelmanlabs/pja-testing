...
class JFormFieldModal_Users extends FormField
{
    ...
    protected function getInput()
    {
        ...
        $link = 'index.php?option=com_planjeagenda&amp;view=editevent&amp;layout=chooseusers&amp;tmpl=component&amp;function=jSelectUsers_'.$this->id.'&amp;a_id='.$eventid;
    ...
    //    if (empty($count)) {
    //        $count = Text::_('com_planjeagenda_SELECT_USERS');
    //    }
    //    $count = htmlspecialchars($count, ENT_QUOTES, 'UTF-8');
        ...
        // $html[] = '    <a class="flyermodal" title="'.Text::_('com_planjeagenda_SELECT').'" href="'.$link.'&amp;'.Session::getFormToken().'=1" rel="{handler: \'iframe\', size: {x:800, y:450}}">'.
        ...
        $html[] ='<button type="button" class="btn btn-link" data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#user-modal">'.Text::_('com_planjeagenda_SELECT').'
        </button>';
