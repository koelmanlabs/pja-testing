...
// Load admin EventModel - it's PSR-4 autoloaded, just reference it
// PlanjeagendaModelEvent is an alias for the namespaced admin EventModel
if (!class_exists('PlanjeagendaModelEvent', false)) {
    class_alias(
        'KoelmanLabs\\Component\\Planjeagenda\\Administrator\\Model\\EventModel',
        'PlanjeagendaModelEvent'
    );
}
 ...
 * Editevent Model
 */
class PlanjeagendaModelEditevent extends PlanjeagendaModelEvent
{
    /**
