...
class PlanjeagendaModelCategoriesFrontend extends BaseDatabaseModel
{
    protected $_id         = null;
...
if (!class_exists('PlanjeagendaModelCategories')) {
    class_alias('PlanjeagendaModelCategoriesFrontend', 'PlanjeagendaModelCategories');
}
