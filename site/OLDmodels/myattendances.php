 ...
 *
 */
class PlanjeagendaModelMyattendances extends BaseDatabaseModel
{
    ...
    public function __construct()
    {
        ...
        if ($app->input->getInt('limitstart', null) === null) {
            $app->setUserState('com_planjeagenda.myattendances.limitstart', 0);
        }

        $limit      = $app->getUserStateFromRequest('com_planjeagenda.myattendances.limit', 'limit', $jemsettings->display_num, 'int');
        $limitstart = $app->getUserStateFromRequest('com_planjeagenda.myattendances.limitstart', 'limitstart', 0, 'int');
    ...
    protected function _buildQueryAttending()
    {
        ...
        $query = 'SELECT DISTINCT a.id AS eventid, a.dates, a.enddates, a.times, a.endtimes, a.title, a.created, a.locid, a.published, '
               ...
               . ' LEFT JOIN #__pja_register AS r ON r.event = a.id'
    ...
    protected function _buildOrderByAttending()
    {
        ...
        $filter_order_Dir = $app->getUserStateFromRequest('com_planjeagenda.myattendances.filter_order_Dir', 'filter_order_Dir', $filter_order_DirDefault, 'word');
