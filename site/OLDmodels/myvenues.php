 ...
 *
 */
class PlanjeagendaModelMyvenues extends BaseDatabaseModel
{
    /**
     * Venues data array
     *
    ...
    public function __construct()
    {
        ...
        if ($app->input->getInt('limitstart', null) === null) {
            $app->setUserState('com_planjeagenda.myvenues.limitstart', 0);
        }

        $limit      = $app->getUserStateFromRequest('com_planjeagenda.myvenues.limit', 'limit', $jemsettings->display_num, 'int');
        $limitstart = $app->getUserStateFromRequest('com_planjeagenda.myvenues.limitstart', 'limitstart', 0, 'int');
