...
<script>
    $(document).ready(function () {
        ...
        var $restOfContent = $(".klevents-dl-rest").children("dd, dt");
...
<div id="klevents" class="jem_editevent<?php echo $this->pageclass_sfx; ?>">
    <div class="edit item-page">
        ...
        <form enctype="multipart/form-data" action="<?php echo Route::_('index.php?option=com_planjeagenda&a_id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
            ...
            <?php if ($this->item->recurrence_type > 0) : ?>
                <div class="description warningrecurrence" style="clear: both;">
                    <div style="float:left;">
                        <?php echo \PlanjeagendaOutput::recurrenceicon($this->item, false, false); ?>
                    </div>
            ...
            <!-- DETAILS TAB -->
            <?php //echo \HTMLHelper::_('tabs.panel', \Text::_('com_planjeagenda_EDITEVENT_INFO_TAB'), 'editevent-infotab'); ?>
            <?php echo HTMLHelper::_('uitab.startTabSet', 'myTab', ['active' => 'editevent-infotab', 'recall' => true, 'breakpoint' => 768]); ?>
            <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'editevent-infotab', Text::_('com_planjeagenda_EDITEVENT_INFO_TAB')); ?>

            <fieldset>
                <legend><?php echo Text::_('com_planjeagenda_EDITEVENT_DETAILS_LEGEND'); ?></legend>
            ...
            <!-- EVENTDESCRIPTION -->
            <fieldset>
                <legend><?php echo Text::_('com_planjeagenda_EVENT_DESCRIPTION'); ?></legend>
            ...
            <?php if ($this->item->datimage || $this->jemsettings->imageenabled != 0) : ?>
                <fieldset class="jem_fldst_image">
                    ...
                    if ($this->item->datimage) :
                        echo OutputHelper::flyer($this->item, $this->dimage, 'event', 'datimage');
                    ...
                    <?php if ($this->jemsettings->imageenabled != 0) : ?>
                        <ul class="adminformlist">
                            ...
                            <?php
                            if ($this->item->datimage) :
                                echo HTMLHelper::image('media/com_planjeagenda/images/publish_r.webp', null, array('id' => 'userfile-remove', 'data-id' => $this->item->id, 'data-type' => 'events', 'title' => \Text::_('com_planjeagenda_REMOVE_IMAGE')));
            ...
            <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'editevent-extendedtab', Text::_('com_planjeagenda_EDITEVENT_EXTENDED_TAB')); ?>
            <?php //echo HTMLHelper::_('tabs.panel', \Text::_('com_planjeagenda_EDITEVENT_EXTENDED_TAB'), 'editevent-extendedtab'); ?>
            <?php echo $this->loadTemplate('extended'); ?>

            <!-- PUBLISH TAB -->
            <?php echo HTMLHelper::_('uitab.endTab'); ?>
            <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'editevent-publishtab', Text::_('com_planjeagenda_EDITEVENT_PUBLISH_TAB')); ?>
            <?php //echo HTMLHelper::_('tabs.panel', \Text::_('com_planjeagenda_EDITEVENT_PUBLISH_TAB'), 'editevent-publishtab'); ?>
            <?php echo $this->loadTemplate('publish'); ?>

            <!-- ATTACHMENTS TAB -->
            <?php echo HTMLHelper::_('uitab.endTab'); ?>
            <?php if (!empty($this->item->attachments) || ($this->jemsettings->attachmentenabled != 0)) : ?>
                <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'event-attachments', Text::_('com_planjeagenda_EVENT_ATTACHMENTS_TAB')); ?>
                <?php //echo \HTMLHelper::_('tabs.panel', Text::_('com_planjeagenda_EVENT_ATTACHMENTS_TAB'), 'event-attachments'); ?>
                <?php echo $this->loadTemplate('attachments'); ?>
                <?php echo HTMLHelper::_('uitab.endTab'); ?>
            <?php endif; ?>

            <!-- OTHER TAB -->
            <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'event-other', Text::_('com_planjeagenda_EVENT_OTHER_TAB')); ?>
            <?php //echo \HTMLHelper::_('tabs.panel', Text::_('com_planjeagenda_EVENT_OTHER_TAB'), 'event-other'); ?>
            <?php echo $this->loadTemplate('other'); ?>
            <?php echo HTMLHelper::_('uitab.endTab'); ?>
            <?php //echo HTMLHelper::_('tabs.end'); ?>

            <input type="hidden" name="task" value="" />
            <input type="hidden" name="area" value="form" />
