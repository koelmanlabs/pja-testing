...
<fieldset class="panelform">
    ...
    <ul class="adminformlist">
        ...
        <li id="counter_row" style="display: none;">
            ...
            <br><div class="recurrence_notice"><small>
                    ...
                    $limitdate = '<strong>' . OutputHelper::formatLongDateTime($limitdate->format('Y-m-d'), '') . '</strong>';
    ...
    <script>
        ...
        $select_output[1] = "<?php
            echo Text::_('com_planjeagenda_OUTPUT_DAY');
            ?>";
        $select_output[2] = "<?php
            echo Text::_('com_planjeagenda_OUTPUT_WEEK');
            ?>";
        $select_output[3] = "<?php
            echo Text::_('com_planjeagenda_OUTPUT_MONTH');
            ?>";
        $select_output[4] = "<?php
            echo Text::_('com_planjeagenda_OUTPUT_WEEKDAY');
            ?>";
        $select_output[5] = "<?php
            echo Text::_('com_planjeagenda_OUTPUT_YEAR');
            ?>";
        $select_output[6] = "<?php
            echo Text::_('com_planjeagenda_OUTPUT_LASTDAY');
            ?>";
        ...
        var $before_last = "<?php
            echo Text::_('com_planjeagenda_BEFORE_LAST');
            ?>";
        var $last = "<?php
            echo Text::_('com_planjeagenda_LAST');
            ?>";
    ...
    if (!empty($this->item->recurr_bak->recurrence_type)) {
        ...
        if (!empty($rlDate)) {
            $recurr_limit_date = OutputHelper::formatdate($rlDate);
        } else {
        ...
        if (!empty($recurr_type)) {
            ...
            <ul class="adminformlist">
                <li>
                    <label><?php echo Text::_('com_planjeagenda_RECURRING_FIRST_EVENT_ID'); ?></label>
                    <input type="text" class="readonly" readonly="readonly" value="<?php echo $recurrence_first_id; ?>">
                </li>
                <li>
                    <label><?php echo Text::_('com_planjeagenda_RECURRENCE'); ?></label>
                ...
                <li>
                    <label><?php echo Text::_('com_planjeagenda_RECURRENCE_COUNTER'); ?></label>
    ...
    <ul class="adminformlist">
        ...
        <?php else : ?>
            ...
            <div id="optional-limited">
                <li><div id="registra_from"  class="d-contents"><label><?php echo Text::_('com_planjeagenda_EVENT_FIELD_REGISTRATION_FROM');?></label><?php echo $this->form->getInput('registra_from'); ?><span id="jform_registra_from2"> <?php echo Text::_('com_planjeagenda_EVENT_FIELD_REGISTRATION_FROM_POSTFIX'); ?></span></div></li>
                <li><div id="registra_until" class="d-contents"><label><?php echo Text::_('com_planjeagenda_EVENT_FIELD_REGISTRATION_UNTIL');?></label><?php echo $this->form->getInput('registra_until'); ?><span id="jform_registra_until2"> <?php echo Text::_('com_planjeagenda_EVENT_FIELD_REGISTRATION_UNTIL_POSTFIX'); ?></span></div></li>
                <br>
            </div>
            <div id="optional-fields">
                ...
                <br>
                <li><div id="unregistra_until" class="d-contents"><label></label><?php echo $this->form->getInput('unregistra_until'); ?><span id="jform_unregistra_until2"> <?php echo Text::_('com_planjeagenda_EVENT_FIELD_ANNULATION_UNTIL_POSTFIX'); ?></span></div></li>
                <br>
                ...
                <br>
                <li><label style='margin-top: 1rem;'><?php echo Text::_ ('com_planjeagenda_EDITEVENT_FIELD_RESERVED_PLACES');?></label> <?php echo $this->form->getInput('reservedplaces'); ?></li>
                <br>
                ...
                <?php if ($this->jemsettings->regallowinvitation == 1) : ?>
                    ...
                    <br>
                <?php endif; ?>
                <li><label style='margin-top: 1rem;'><?php echo Text::_ ('com_planjeagenda_EDITEVENT_FIELD_BOOKED_PLACES');?></label> <?php echo '<input id="event-booked" class="form-control readonly inputbox" type="text" readonly="true" value="' . $this->item->booked . '" />'; ?></li>
                <br>
