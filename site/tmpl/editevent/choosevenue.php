...
<div id="klevents" class="jem_select_venue">
    ...
    <form action="<?php echo \Route::_('index.php?option=com_planjeagenda&view=editevent&layout=choosevenue&tmpl=component&function='.$this->escape($function).'&'.Session::getFormToken().'=1'); ?>" method="post" name="adminForm" id="adminForm">
        ...
        <table class="eventtable table table-striped" style="width:100%" summary="klevents">
            <thead>
            <tr>
                <th style="width: 7px; text-align: left;" class="sectiontableheader"><?php echo \Text::_('com_planjeagenda_NUM'); ?></th>
                <th style="text-align: left;" class="sectiontableheader"><?php echo \HTMLHelper::_('grid.sort', 'com_planjeagenda_VENUE', 'l.venue', $this->lists['order_Dir'], $this->lists['order'], 'selectvenue' ); ?></th>
                <th style="text-align: left;" class="sectiontableheader"><?php echo \HTMLHelper::_('grid.sort', 'com_planjeagenda_CITY', 'l.city', $this->lists['order_Dir'], $this->lists['order'], 'selectvenue' ); ?></th>
                <th style="text-align: left;" class="sectiontableheader"><?php echo \HTMLHelper::_('grid.sort', 'com_planjeagenda_STATE', 'l.state', $this->lists['order_Dir'], $this->lists['order']); ?></th>
                <th style="text-align: left;" class="sectiontableheader"><?php echo \Text::_('com_planjeagenda_COUNTRY'); ?></th>
            </tr>
            </thead>
            <tbody>
            <?php if (empty($this->rows)) : ?>
                <tr style="text-align: center"><td colspan="0"><?php echo \Text::_('com_planjeagenda_NOVENUES'); ?></td></tr>
            <?php else :?>
