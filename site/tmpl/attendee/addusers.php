...
<div id="klevents" class="jem_select_users">
    ...
    <form action="<?php echo \Route::_('index.php?option=com_planjeagenda&view=attendees&layout=addusers&tmpl=component&function='.$this->escape($function).'&id='.$this->event->id.'&'.Session::getFormToken().'=1'); ?>" method="post" name="adminForm" id="adminForm">
        ...
        <table class="eventtable table table-striped" style="width:100%" summary="klevents">
            <thead>
                <tr>
                    <th style="width: 1%" class="sectiontableheader"><?php echo \Text::_('com_planjeagenda_NUM'); ?></th>
                    ...
                    <th style="text-align: left;" class="sectiontableheader"><?php echo \Text::_('com_planjeagenda_NAME'); ?></th>
                    <th style="width: 10%" class="center"><?php echo \Text::_('com_planjeagenda_STATUS'); ?></th>
                    <th style="width: 10%" class="center"><?php echo \Text::_('com_planjeagenda_PLACES'); ?></th>
                </tr>
            </thead>
            <tbody>
                <?php if (empty($this->rows)) : ?>
                    <tr style="text-align: center;"><td colspan="0"><?php echo \Text::_('com_planjeagenda_NOUSERS'); ?></td></tr>
                <?php else :?>
        ...
        <div class="klevents-row klevents-justify-start valign-baseline">
            ...
            <div class="choose-places">
                <?php echo \Text::_('com_planjeagenda_SELECT');?> <?php echo \Text::_('com_planjeagenda_PLACES'); ?>
            </div>
