...
<div id="klevents" class="jem_attendees<?php echo $this->pageclass_sfx;?>">
    <div class="buttons">
        ...
        echo \PlanjeagendaOutput::createButtonBar($this->getName(), $permissions, $btn_params);
        ?>
    </div>
    ...
    <form action="<?php echo htmlspecialchars($this->action); ?>"  method="post" name="adminForm" id="adminForm">
        <table class="adminlist">
            <tr>
                <td style="width: 80%">
                    <b><?php echo \Text::_('com_planjeagenda_TITLE').':'; ?></b>&nbsp;
                    ...
                    <br>
                    <b><?php echo \Text::_('com_planjeagenda_DATE').':'; ?></b>&nbsp;<?php
                        echo \PlanjeagendaOutput::formatLongDateTime($this->event->dates, $this->event->times, $this->event->enddates, $this->event->endtimes, $this->settings->get('global_show_timedetails', 1)); ?>
                </td>
            </tr>
        </table>
        <br>
        ...
        <div id="jem_filter" class="floattext">
            <div class="jem_fleft">
                <label for="filter"><?php echo \Text::_('com_planjeagenda_SEARCH'); ?></label>
            ...
            <div class="jem_fleft" style="white-space:nowrap;">
                <?php echo \Text::_('com_planjeagenda_STATUS').' '.$this->lists['status']; ?>
            </div>
        ...
        <div class="table-responsive">
            <table class="eventtable table table-striped" style="margin: 20px 0 0 0;" id="articleList">
                <thead>
                    <tr>
                        <th style="width: 1%" class="center"><?php echo \Text::_('com_planjeagenda_NUM'); ?></th>
                        ...
                        <?php endif; ?>
                        <th class="title"><?php echo \HTMLHelper::_('grid.sort', 'com_planjeagenda_REGDATE', 'r.uregdate', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
                        <th class="center"><?php echo \HTMLHelper::_('grid.sort', 'com_planjeagenda_STATUS', 'r.status', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
                        <th class="center"><?php echo \HTMLHelper::_('grid.sort', 'com_planjeagenda_PLACES', 'r.places', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
                        <?php if (!empty($this->jemsettings->regallowcomments)) : ?>
                        <th class="title"><?php echo \Text::_('com_planjeagenda_COMMENT'); ?></th>
                        <?php endif;?>
                        <th class="center"><?php echo \Text::_('com_planjeagenda_REMOVE_USER'); ?></th>
                    </tr>
                </thead>
                <tbody>
