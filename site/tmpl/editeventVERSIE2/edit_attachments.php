...
<fieldset>
    <legend><?php echo \Text::_('com_planjeagenda_ATTACHMENTS_LEGEND'); ?></legend>
            ...
            <tr>
                <td style="width: 100%;">
                    <dl class="klevents-dl">
                        <dt><?php echo \Text::_('com_planjeagenda_ATTACHMENT_FILE'); ?></dt>
                        ...
                        <dt><?php echo \Text::_('com_planjeagenda_ATTACHMENT_NAME'); ?></dt>
                        <?php /* name is always editable, also if attachemnt upload is not allowed */ ?>
                        <dd><input type="text" name="attached-name[]" value="<?php echo $this->escape($file->name); ?>" /></dd>

                        <dt><?php echo \Text::_('com_planjeagenda_ATTACHMENT_DESCRIPTION'); ?></dt>
                        <?php /* description is always editable, also if attachemnt upload is not allowed */ ?>
                        <dd><input type="text" name="attached-desc[]" value="<?php echo $this->escape($file->description); ?>" /></dd>
                    </dl>
                    <?php if ($this->jemsettings->attachmentenabled != 0) : ?>
                        ...
                        ?>
                        <?php echo \Text::_('com_planjeagenda_GLOBAL_REMOVE_ATTACHEMENT') . ' ' . $file->name; ?>
                        <?php echo \PlanjeagendaOutput::removebutton(\Text::_('com_planjeagenda_GLOBAL_REMOVE_ATTACHEMENT'), array('id' => 'attach-remove' . $file->id . ':' . Session::getFormToken(), 'class' => 'attach-remove', 'title' => \Text::_('com_planjeagenda_GLOBAL_REMOVE_ATTACHEMENT'))); ?>

                    <?php endif; ?>
                </td>
                <td>
                    <div>
                        <div><?php echo \Text::_('com_planjeagenda_ATTACHMENT_ACCESS'); ?></div>
                        <?php
    ...
    <legend><?php echo \Text::_('com_planjeagenda_ADD_USER_REGISTRATIONS') . ' ' . \Text::_('com_planjeagenda_ATTACHMENTS_LEGEND'); ?></legend>
