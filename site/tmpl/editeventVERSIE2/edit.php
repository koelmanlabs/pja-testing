...
<div id="klevents" class="jem_editevent<?php echo $this->pageclass_sfx; ?>">
    <div class="edit item-page">
        ...
        <form enctype="multipart/form-data" action="<?php echo Route::_('index.php?option=com_planjeagenda&a_id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
            ...
            <?php if ($this->item->recurrence_type > 0) : ?>
                <div class="description warningrecurrence" style="clear: both;">
                    <div style="float:left;">
                        <?php echo OutputHelper::recurrenceicon($this->item, false, false); ?>
                    </div>
            ...
            <!-- EVENTDESCRIPTION -->
            <fieldset class="adminform">
                <legend><?php echo Text::_('com_planjeagenda_EDITEVENT_DESCRIPTION_LEGEND'); ?></legend>
                <div>
                    ...
                    <?php if ($this->jemsettings->imageenabled != 0) : ?>
                        <dl class="adminformlist klevents-dl">
                            ...
                            <?php if ($this->item->datimage) : ?>
                                <dd>
                                    <?php echo \PlanjeagendaOutput::flyer($this->item, $this->dimage, 'event', 'datimage'); ?>
                            ...
                            <?php if ($this->item->datimage) : ?>
                                ...
                                <dd><?php
                                    echo HTMLHelper::image('media/com_planjeagenda/images/publish_r.webp', null, array('id' => 'userfile-remove', 'data-id' => $this->item->id, 'data-type' => 'events', 'title' => Text::_('com_planjeagenda_REMOVE_IMAGE'), 'class' => 'btn')); ?>
                                </dd>
                            <?php endif; ?>
                        </dl>
